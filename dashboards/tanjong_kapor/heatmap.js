...
// boundary
fetch('../../N04_tanjong_kapor.geojson')
.then(r=>r.json())
.then(data=>{
  L.geoJSON(data,{
...
// CSV
const csvUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS_IDKPPAIXxMbSV_DLpPvUwsPd4ljUCcoa6JfYwEo8UEwQEllOSKM8MCAdz3VxYsvkqZDTiPylsztM/pub?output=csv"
