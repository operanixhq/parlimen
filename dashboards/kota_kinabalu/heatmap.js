...
// boundary
fetch('../../P172_kota_kinabalu.geojson')
.then(r=>r.json())
.then(data=>{
  L.geoJSON(data,{
...
// CSV
const csvUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQSGKoQ3Dlhc28Usz8icu4R-Mnn3HcHGtj9h66pSVO8oMIo3yUy-lgomC24ol9CljTSKmUVn-iSJn0T/pub?output=csv"
