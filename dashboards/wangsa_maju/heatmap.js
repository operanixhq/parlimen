...
// boundary
fetch('../../P116_wangsa_maju.geojson')
.then(r=>r.json())
.then(data=>{
  L.geoJSON(data,{
...
// CSV
const csvUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS8EfQANayGvEbuUN1X0s3LldmzzY3T5kvDrVBD0KZcoAVLIfvvQCucNWLl0u95dgifuIw2Uw1hYfmn/pub?output=csv"
